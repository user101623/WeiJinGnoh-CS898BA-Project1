...
For this project, Sobel is the most effective all-around performer, providing the most consistent and usable edge maps. Prewitt serves as a strong secondary option, particularly for bright or high-contrast images where it offers a cleaner output by avoiding the excessive edge sensitivity seen in Sobel.

# Output Examples

![base_hls_sigma_0.5_comparison.png](output_plots\base_hls_sigma_0.5_comparison.png)
![base_hls_t1_sigma_0.0_comparison.png](output_plots\base_hls_t1_sigma_0.0_comparison.png)
![base_hls_t2_sigma_0.5_comparison.png](output_plots\base_hls_t2_sigma_0.5_comparison.png)
![base_hls_t1_sigma_2.0_comparison.png](output_plots\base_hls_t1_sigma_2.0_comparison.png)
![base_cielab_t2_sigma_0.0_comparison.png](output_plots\base_cielab_t2_sigma_0.0_comparison.png)
![base_grayscale_t2_sigma_0.5_comparison.png](output_plots\base_grayscale_t2_sigma_0.5_comparison.png)